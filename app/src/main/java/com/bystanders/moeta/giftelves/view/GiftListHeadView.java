 ...
 */
public class GiftListHeadView extends LinearLayout {
    ...
    public GiftListHeadView(Context context) {
        this(context,null);
    }

    public GiftListHeadView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public GiftListHeadView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addAdViewPage() {
        ...
        view.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, 400));
